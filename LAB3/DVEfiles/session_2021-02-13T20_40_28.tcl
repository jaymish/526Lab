...
# DVE full session
# Saved on Sat Feb 13 20:40:28 2021
# Designs open: 1
...
#<Session mode="Full" path="/home/users9/jp581081/526LSP21/LAB3/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1518 806}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 150} {height 497} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 513
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 150} {height 497} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1238} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
if { ![gui_is_db_opened -db {/home/users9/jp581081/526LSP21/LAB3/vcdplus.vpd}] } {
	gui_open_db -design V1 -file /home/users9/jp581081/526LSP21/LAB3/vcdplus.vpd -nosource
}
...
gui_get_drivers -session -id ${DriverLoad.1} -signal lab3_tb.clock -time 210 -starttime 210
