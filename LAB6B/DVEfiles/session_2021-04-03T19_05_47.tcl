...
# DVE full session
# Saved on Sat Apr 3 19:05:47 2021
# Designs open: 1
...
#<Session mode="Full" path="/home/users9/jp581081/526LSP21/LAB6B/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1484 812}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 151} {height 566} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 178} {height 566} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1476} {height 116} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/home/users9/jp581081/526LSP21/LAB6B/vcdplus.vpd}] } {
	gui_open_db -design V1 -file /home/users9/jp581081/526LSP21/LAB6B/vcdplus.vpd -nosource
}
...
gui_load_child_values {text.SOP1.S1.R1}
gui_load_child_values {text.SOP1.S1.R2}
...
gui_sg_addsignal -group "$_session_group_1" { text.DATA_IN text.C0 text.C1 text.C2 text.C3 text.CLK text.OUT_sop1 text.OUT_sop2 }
...
gui_sg_addsignal -group "$_session_group_2" { text.C0 text.C1 text.C2 text.C3 text.DATA_IN text.OUT_sop1 text.OUT_sop2 }
gui_set_radix -radix {decimal} -signals {V1:text.C0}
gui_set_radix -radix {unsigned} -signals {V1:text.C0}
gui_set_radix -radix {decimal} -signals {V1:text.C1}
gui_set_radix -radix {unsigned} -signals {V1:text.C1}
...
gui_sg_addsignal -group "$_session_group_3" { text.DATA_IN text.SOP1.S1.R1.R text.SOP1.S1.R2.R text.SOP1.S2.R1.R text.SOP1.S2.R2.R text.SOP2.r0 text.SOP2.r1 text.SOP2.r2 text.SOP2.r3 text.C0 text.C1 text.C2 text.C3 text.OUT_sop1 text.OUT_sop2 }
gui_set_radix -radix {decimal} -signals {V1:text.DATA_IN}
gui_set_radix -radix {unsigned} -signals {V1:text.DATA_IN}
...
catch {gui_list_select -id ${Hier.1} {text}}
...
gui_list_show_data -id ${Data.1} {text}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {text.C0 text.C1 text.C2 text.C3 text.DATA_IN text.OUT_sop1 text.OUT_sop2 }}
