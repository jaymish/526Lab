...
# DVE full session
# Saved on Mon Mar 29 23:16:37 2021
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1487 815}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1479} {height 119} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { text.DATA_IN text.SOP1.S1.R1.R text.SOP1.S1.R2.R text.SOP1.S2.R1.R text.SOP1.S2.R2.R }
