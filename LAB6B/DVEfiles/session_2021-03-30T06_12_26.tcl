...
# DVE full session
# Saved on Mon Mar 29 23:26:35 2021
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1486 814}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1478} {height 118} {dock_state bottom} {dock_on_new_line true}}
...
gui_view_scroll -id ${Source.1} -vertical -set 525
